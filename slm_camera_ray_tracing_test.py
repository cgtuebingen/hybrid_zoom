...
import slm_camera_ray_tracing_v01 as slm_c
...
# Test object plane
object_plane_image = cv2.imread("/home/chenjiee/Documents/standard_test_images/ISO_12233-reschart.png",cv2.IMREAD_GRAYSCALE)
...
# Test method: slm.modulation

# Test different resolutions of sensor, planar object, and etc.
